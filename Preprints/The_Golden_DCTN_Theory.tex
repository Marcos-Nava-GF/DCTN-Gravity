...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|l|c|l|l|p{0.4\textwidth}|}
\hline
\textbf{Class} & \textbf{Particle} & \textbf{Sym} & \textbf{Nodes ($N$)} & \textbf{Type} & \textbf{Network Status \& Behavior} \\ \hline
I. Transparency & Neutrino & $\nu$ & 2 & Fibonacci ($F_3$) & \textbf{Topological Transparency:} Minimal interaction. Stable. \\ \hline
II. Golden Stability & Electron & $e^-$ & 13 & Fibonacci ($F_7$) & \textbf{Irreducible Attractor:} Golden stability limit. Immune to decay due to minimal entropy. \\ \hline
II. Golden Stability & X17 / Axion & $X_{17}$ & 89 & Fibonacci ($F_{11}$) & \textbf{Dark Matter Carrier:} Predicted stable candidate. A heavier Fibonacci shield. \\ \hline
III. Resonance & Muon & $\mu$ & 2,688 & Composite & \textbf{Disharmonic Resonance:} Unstable "second-generation" error. Dissolves into $e^-$. \\ \hline
IV. Complexity Hubs & Proton & $p^+$ & 23,869 & Prime Hub & \textbf{Causal Anchor:} Maximal complexity. Primalty prevents factorization, generating gravity. \\ \hline
IV-B. Over-Saturated & Neutron & $n^0$ & $\sim$23,902 & Composite & \textbf{Beta-Instability:} Over-saturated proton. Sheds $\sim$33 nodes to reach Prime attractor. \\ \hline
V. Bridges & Pions/Kaons & $\pi, K$ & 3k - 12k & Composite & \textbf{Ephemeral Bridges:} Temporary links formed during bandwidth saturation (Strong Force). \\ \hline
VI. Heavy Resonances & $\tau, W, Z$ & - & 45k - 2.3M & Composite & \textbf{Saturation Mediators:} High-mass clusters representing severe network "lag". \\ \hline
VII. Universal Limits & Higgs & $H^0$ & 3,182,732 & Super-Knot & \textbf{The Regulator:} Defines the saturation threshold. \\ \hline
VII. Universal Limits & Top Quark & $t$ & $\sim$4.4M & Limit Prime? & \textbf{Quasi-Singularity:} On the verge of collapsing into a micro-saturated hub (Black Hole). \\ \hline
\end{tabular}%
}

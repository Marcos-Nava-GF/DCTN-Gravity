...
Applying these Golden parameters to cosmic scales, we find that the expansion of the universe is a thermodynamic process of entropy maximization\footnote{In this context, "temperature" is defined not as molecular kinetic energy, but as the \textbf{Connectivity Rate} of the network—analogous to the Unruh temperature in geometric thermodynamics.}.

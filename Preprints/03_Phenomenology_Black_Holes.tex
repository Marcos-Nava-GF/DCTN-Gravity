...
A Black Hole emerges when a standard Tensor Hub (like a massive star) exceeds a critical cohesion threshold ($\beta_{crit}$), causing the network to self-compress into a Saturated Hub.
